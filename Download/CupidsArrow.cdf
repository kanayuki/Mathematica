...
NotebookDataLength[     78518,       1553]
NotebookOptionsPosition[     52520,        989]
NotebookOutlinePosition[     78762,       1550]
CellTagsIndexPosition[     78651,       1544]
WindowTitle->Cupid's Arrow
WindowFrame->Normal*)
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`x$$ = 2, Typeset`show$$ = True, 
    ...
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`x$$], 2, "shoot"}, 2, 0}}, Typeset`size$$ = {
    400., {173., 177.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`x$4035$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`x$$ = 2}, 
      "ControllerVariables" :> {
        Hold[$CellContext`x$$, $CellContext`x$4035$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> Show[$CellContext`gr, 
        Graphics3D[{
          Thickness[0.01], 
          Translate[
           $CellContext`myCone[(2/3) {-1, -1, -1} - 0.1, (2/3) {-1, -1, -1}, 
            Pi/20], {$CellContext`x$$, $CellContext`x$$, $CellContext`x$$}], 
          Translate[
           
           Cylinder[{(2/3) {-1, -1, -1}, (2/3) {1, 1, 1}}, 
            0.015], {$CellContext`x$$, $CellContext`x$$, $CellContext`x$$}], 
          Translate[
           (Rotate[#, Pi, {42 Degree, -1, -1}, (2/3) {1, 1, 1}]& )[
            Translate[
             $CellContext`arrowGuide[
              
              Polygon[{{-0.06, 0.06, 0}, {0, 0, 0}, {
                0.02, 0, 0}, {-0.04, 0.06, 0}}], 3, 0.015, 0.03, 3], (2/3) {1,
               1, 1}]], {$CellContext`x$$, $CellContext`x$$, \
$CellContext`x$$}]}]], 
      "Specifications" :> {{{$CellContext`x$$, 2, "shoot"}, 2, 0}}, 
      "Options" :> {TrackedSymbols :> {$CellContext`x$$}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{447., {217., 222.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(($CellContext`myCone[
         ...
         Pattern[$CellContext`alpha$, 
          Blank[]]] := 
       Module[{$CellContext`gc$, $CellContext`len$, $CellContext`v$, \
$CellContext`n1$, $CellContext`n2$, $CellContext`n1y$, $CellContext`n1z$, \
$CellContext`n2x$, $CellContext`n2y$, $CellContext`n2z$, $CellContext`r$}, \
$CellContext`len$ = 
          Norm[$CellContext`p2$ - $CellContext`p1$]; $CellContext`v$ = 
          N[($CellContext`p2$ - $CellContext`p1$)/$CellContext`len$]; If[
           MatchQ[$CellContext`v$, {
             Pattern[$CellContext`x$$, 
              Blank[]], 0., 0.}], {$CellContext`n1$, $CellContext`n2$} = {{0, 
             1, 0}, {0, 0, 1}}; 
           Null, {$CellContext`n1$, $CellContext`n2$} = {{
              0, $CellContext`n1y$, $CellContext`n1z$}, {$CellContext`n2x$, \
$CellContext`n2y$, $CellContext`n2z$}}; $CellContext`n1$ = 
            ReplaceAll[$CellContext`n1$, 
              First[
               Quiet[
                
                Solve[{Dot[$CellContext`n1$, $CellContext`v$] == 0, 
                  Dot[$CellContext`n1$, $CellContext`n1$] == 
                  Dot[$CellContext`v$, $CellContext`v$]}, {$CellContext`n1y$, \
$CellContext`n1z$}]]]]; $CellContext`n2$ = ReplaceAll[$CellContext`n2$, 
              First[
               Quiet[
                
                Solve[{Dot[$CellContext`n2$, $CellContext`v$] == 0, 
                  Dot[$CellContext`n2$, $CellContext`n1$] == 0, 
                  Dot[$CellContext`n2$, $CellContext`n2$] == 
                  Dot[$CellContext`v$, $CellContext`v$]}, \
$CellContext`n2$]]]]; Null]; $CellContext`r$ = 
          Norm[$CellContext`p2$ - $CellContext`p1$] Tan[$CellContext`alpha$]; 
         Part[
           
           ParametricPlot3D[($CellContext`h $CellContext`v$ + \
(($CellContext`r$ Sin[$CellContext`t]) $CellContext`n1$) 
              Rescale[$CellContext`h, {(-$CellContext`len$)/
                 2, $CellContext`len$/2}] + (($CellContext`r$ 
                Cos[$CellContext`t]) $CellContext`n2$) 
              Rescale[$CellContext`h, {(-$CellContext`len$)/
                 2, $CellContext`len$/
                 2}]) + ($CellContext`p1$ + ($CellContext`p2$ - \
$CellContext`p1$)/2), {$CellContext`h, (-$CellContext`len$)/
             2, $CellContext`len$/2}, {$CellContext`t, 0, 2 Pi}, PlotPoints -> 
            15, Mesh -> None, MaxRecursion -> 0], 1]]; $CellContext`arrowGuide[
         Pattern[$CellContext`polygon, 
          Blank[]], 
         Optional[
          Pattern[$CellContext`repeated, 
           Blank[]], 1], 
         Optional[
          Pattern[$CellContext`repeatedBuffer, 
           Blank[]], 0], 
         Optional[
          Pattern[$CellContext`diameter, 
           Blank[]], 1], 
         Optional[
          Pattern[$CellContext`numberOfGuides, 
           Blank[]], 3], 
         Optional[
          Pattern[$CellContext`rotationOffset, 
           Blank[]], 0]] := With[{$CellContext`polygonLength = Max[
            Part[$CellContext`polygon, 1, All, 1]]}, 
         (Rotate[#, $CellContext`rotationOffset, {1, 0, 0}, {0, 0, 0}]& )[
          Table[
           (Rotate[#, $CellContext`\[Theta], {1, 0, 0}, {0, 0, 0}]& )[
            
            Translate[$CellContext`polygon, {$CellContext`polygonLength + \
$CellContext`i, 0 + $CellContext`diameter/2, 0}]], {$CellContext`i, 
            0, $CellContext`polygonLength ($CellContext`repeated - 
              1) + ($CellContext`repeated - 
              1) $CellContext`repeatedBuffer, $CellContext`polygonLength + \
$CellContext`repeatedBuffer}, {$CellContext`\[Theta], 0, 2 Pi - 
            2 (Pi/$CellContext`numberOfGuides), 
            2 (Pi/$CellContext`numberOfGuides)}]]]; $CellContext`Trott[
         Pattern[$CellContext`x, 
          Blank[]], 
         ...
         Pattern[$CellContext`z, 
          Blank[]]] := 
       320 (($CellContext`x^2 + (3/2)^2 $CellContext`y^2 + $CellContext`z^2 - 
           1)^3 - $CellContext`x^2 $CellContext`z^3 - (((3/2)^2/
           20) $CellContext`y^2) $CellContext`z^3); $CellContext`gr = 
       ContourPlot3D[$CellContext`Trott[$CellContext`x$$, $CellContext`y, \
$CellContext`z] == 
         0, {$CellContext`x$$, (-3)/2, 3/2}, {$CellContext`y, (-3)/2, 3/
          2}, {$CellContext`z, (-3)/2, 3/2}, Boxed -> False, PlotPoints -> 5, 
         MaxRecursion -> 3, ViewPoint -> {0.26, 3, 0.22}, Axes -> False, Mesh -> 
         False, ContourStyle -> Directive[Red, 
           Specularity[White, 10]], ImageSize -> {400, 350}, BoundaryStyle -> 
         None]); Typeset`initDone$$ = True),
...
Cell["\<\
The mythical Cupid shoots his arrows into the hearts of his lovestruck \
targets.\
\>", "ManipulateCaption"],
...
Cell[TextData[{
 ButtonBox["Heart Surface",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/HeartSurface.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
gGCQDeJBQn8AEYN5ZQ==
  ...
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/versions/source.jsp?id=CupidsArrow&\
version=0009"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/CupidsArrow/CupidsArrow-source.nb"]], \
...
Cell[TextData[{
 ...
 ButtonBox["Jesse Nochella",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Jesse%\
20Nochella"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Jesse%20Nochella"]
}], "Author",
 FontColor->GrayLevel[0.6]],

Cell[TextData[{
 "\"",
 ButtonBox["Cupid's Arrow",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CupidsArrow/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CupidsArrow/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/CupidsArrow/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/CupidsArrow/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/CupidsArrow/"],
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[43051, 759, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[43312, 768, 1761, 40, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[51698, 964, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 78365, 1533},
 {"Copyright", 78560, 1538}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1490, 34, 34328, 567, 70, "DemonstrationHeader"],
Cell[35821, 603, 34, 0, 70, "DemoTitle"],
Cell[35858, 605, 7069, 147, 70, "Output",
 CellID->123748657],
Cell[42930, 754, 118, 3, 70, "ManipulateCaption"],
Cell[43051, 759, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43312, 768, 1761, 40, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45076, 810, 44, 0, 70, "RelatedLinksSection"],
Cell[45123, 812, 565, 20, 70, "RelatedLinks",
 CellID->757367925],
Cell[45691, 834, 4772, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[50466, 925, 45, 0, 70, "CitationSection"],
Cell[50514, 927, 334, 10, 70, "Author"],
Cell[50851, 939, 844, 23, 70, "Citations"],
Cell[51698, 964, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature ZRqLMGZPG9f7muAXzXn#dmkY *)
