...
NotebookDataLength[     76000,       1515]
NotebookOptionsPosition[     48951,        933]
NotebookOutlinePosition[     75204,       1494]
CellTagsIndexPosition[     75093,       1488]
WindowTitle->Flower Around a Limit Point
WindowFrame->Normal*)
...
Cell["Flower Around a Limit Point", "DemoTitle",
 CellID->700863240],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`dir$$ = 0, $CellContext`lev$$ = 
    6, $CellContext`pr$$ = Circle, $CellContext`sca$$ = 1, $CellContext`u$$ = 
    6, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`pr$$], Circle, "figures"}, {
      Circle -> "circle", Disk -> "disk", Point -> "point"}}, {{
       Hold[$CellContext`u$$], 6, "petals"}, 3, 12, 1}, {{
       Hold[$CellContext`lev$$], 6, "levels"}, 3, 24, 1}, {{
       Hold[$CellContext`sca$$], 1, "zoom"}, 0, 1}, {{
       Hold[$CellContext`dir$$], 0, "twist"}, (-2) Pi, 2 Pi}}, 
    Typeset`size$$ = {400., {198., 202.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`pr$131593$$ = False, $CellContext`u$131594$$ = 
    0, $CellContext`lev$131595$$ = 0, $CellContext`sca$131596$$ = 
    0, $CellContext`dir$131597$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`dir$$ = 0, $CellContext`lev$$ = 
        6, $CellContext`pr$$ = Circle, $CellContext`sca$$ = 
        1, $CellContext`u$$ = 6}, "ControllerVariables" :> {
        Hold[$CellContext`pr$$, $CellContext`pr$131593$$, False], 
        Hold[$CellContext`u$$, $CellContext`u$131594$$, 0], 
        Hold[$CellContext`lev$$, $CellContext`lev$131595$$, 0], 
        Hold[$CellContext`sca$$, $CellContext`sca$131596$$, 0], 
        Hold[$CellContext`dir$$, $CellContext`dir$131597$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Table[
          ({
           ColorData["BrightBands"][$CellContext`a/$CellContext`u$$], 
           If[$CellContext`pr$$ === Point, Point[#]& , $CellContext`pr$$][{
              
              Cos[$CellContext`dir$$ (($CellContext`k - 1)/$CellContext`u$$) + 
               2 Pi ($CellContext`a/$CellContext`u$$)], 
              
              Sin[$CellContext`dir$$ (($CellContext`k - 1)/$CellContext`u$$) + 
               2 Pi ($CellContext`a/$CellContext`u$$)]} #, # 
            Sin[Pi/$CellContext`u$$]]}& )[(1/(
            1 + $CellContext`sca$$ 
             Sin[Pi/$CellContext`u$$]))^$CellContext`k], {$CellContext`k, 
           1, $CellContext`lev$$, 1}, {$CellContext`a, 1, $CellContext`u$$, 
           1}], 
         RGBColor[1, 0.41, 0]}, Background -> RGBColor[0.86, 0.96, 0.98], 
        ImageSize -> {400, 400}], 
      "Specifications" :> {{{$CellContext`pr$$, Circle, "figures"}, {
         Circle -> "circle", Disk -> "disk", Point -> 
          "point"}}, {{$CellContext`u$$, 6, "petals"}, 3, 12, 1, Appearance -> 
         "Labeled", ImageSize -> Small}, {{$CellContext`lev$$, 6, "levels"}, 
         3, 24, 1, Appearance -> "Labeled", ImageSize -> 
         Small}, {{$CellContext`sca$$, 1, "zoom"}, 0, 1, Appearance -> 
         "Labeled", ImageSize -> 
         Small}, {{$CellContext`dir$$, 0, "twist"}, (-2) Pi, 2 Pi, Appearance -> 
         "Labeled", ImageSize -> Small}}, 
      "Options" :> {ControlPlacement -> Left, AutorunSequencing -> {1, 2, 3}},
       "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{634., {226., 231.}},
...
Cell[TextData[{
 ...
 StyleBox["s",
  FontSlant->"Italic"],
 " is close to an infinite number of points of ",
 StyleBox["s",
  FontSlant->"Italic"],
 ". An equivalent definition: no matter how small a distance \[Epsilon] is \
specified, there is a point ",
 StyleBox["Q",
  FontSlant->"Italic"],
 " of ",
 StyleBox["s",
  ...
  FormBox[
   RowBox[{
    ...
    RowBox[{
     RowBox[{
      RowBox[{"\[Exists]", 
       RowBox[{"Q", "\[NotEqual]", "P"}]}], "\[SuchThat]"}], "|", 
     RowBox[{"P", "-", "Q"}], "|", 
     RowBox[{"<", "\[Epsilon]"}]}]}], TraditionalForm]], "InlineMath"],
 ". Here the limit point is at the center and you control how close the \
graphical elements come to it. Elements closer to the center are drawn \
smaller. "
}], "ManipulateCaption",
 CellID->160241667],
...
Cell[TextData[{
 ButtonBox["Flower of Life",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/FlowerofLife.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["Limit Point",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/LimitPoint.html"], None}],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
FlowerAroundALimitPoint&version=0017"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/FlowerAroundALimitPoint/\
FlowerAroundALimitPoint-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Flower Around a Limit Point",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/FlowerAroundALimitPoint/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/FlowerAroundALimitPoint/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/FlowerAroundALimitPoint/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/FlowerAroundALimitPoint/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/FlowerAroundALimitPoint/"]
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39967, 708, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40228, 717, 691, 15, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[48129, 908, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 74808, 1477},
 {"Copyright", 75002, 1482}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[34922, 590, 68, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[34993, 593, 3846, 72, 70, "Output",
 CellID->315161454],
Cell[38842, 667, 1122, 39, 70, "ManipulateCaption",
 CellID->160241667],
Cell[39967, 708, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40228, 717, 691, 15, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40922, 734, 44, 0, 70, "RelatedLinksSection"],
Cell[40969, 736, 566, 20, 70, "RelatedLinks",
 CellID->422961132],
Cell[41538, 758, 561, 20, 70, "RelatedLinks",
 CellID->928552783],
Cell[42102, 780, 4808, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[46913, 871, 45, 0, 70, "CitationSection"],
Cell[46961, 873, 805, 20, 70, "Citations"],
Cell[47769, 895, 357, 11, 70, "Author",
 CellID->2137581389],
Cell[48129, 908, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature cTa880G195bZ#wA888iqkAPC *)
