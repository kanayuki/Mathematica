...
NotebookDataLength[     76969,       1480]
NotebookOptionsPosition[     50309,        918]
NotebookOutlinePosition[     76730,       1479]
CellTagsIndexPosition[     76619,       1473]
WindowTitle->Length, Width, and Height of an Impossible Object
WindowFrame->Normal*)
...
ressionUUID->"3aa3486b-397f-48d9-b989-59b9d0e5141c"],

Cell["Length, Width, and Height of an Impossible Object", "DemoTitle",ExpressionUUID->"ab772b7c-e4d5-4b64-abe5-31b1f92ac11b"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`a$$ = None, $CellContext`b$$ = 
    False, $CellContext`v$$ = {20, -19.8, 20}, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`v$$], {20, -19.8, 20}, "view"}, {{20, -19.8, 20} -> 
       "mysterious", Above -> "above", Below -> "below", Front -> "front", 
       Back -> "back", Left -> "left", Right -> "right", {Left, Top} -> 
       "left, top", {Right, Top} -> "right top"}}, {{
       Hold[$CellContext`a$$], None, "axes"}, {None, True}}, {{
       Hold[$CellContext`b$$], False, "box"}, {False, True}}, {
      Hold[
       Row[{
         Manipulate`Place[1], 
         Spacer[20], 
    ...
    Typeset`size$$ = {300., {182., 186.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = True, $CellContext`v$3380$$ =
     False, $CellContext`a$3381$$ = False, $CellContext`b$3382$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`a$$ = None, $CellContext`b$$ = 
        False, $CellContext`v$$ = {20, -19.8, 20}}, "ControllerVariables" :> {
        Hold[$CellContext`v$$, $CellContext`v$3380$$, False], 
        Hold[$CellContext`a$$, $CellContext`a$3381$$, False], 
        Hold[$CellContext`b$$, $CellContext`b$3382$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         ...
         Cuboid[{0, 1, 6}, {1, 7, 5}], 
         Cuboid[{1, 6, 5}, {3, 7, 6}], 
         Polygon[{{6, 0, 7}, {7, 0, 7}, {7, 0, 8}}], 
         Polygon[{{6, 1, 7}, {7, 1, 7}, {7, 1, 8}}], 
         Polygon[{{6, 3, 7}, {7, 3, 7}, {7, 3, 8}}], 
         Polygon[{{6, 4, 7}, {7, 4, 7}, {7, 4, 8}}], 
         Polygon[{{7, 0, 7}, {7, 1, 7}, {7, 1, 8}, {7, 0, 8}}], 
         Polygon[{{7, 3, 7}, {7, 4, 7}, {7, 4, 8}, {7, 3, 8}}], 
         Polygon[{{6, 0, 7}, {6, 1, 7}, {7, 1, 8}, {7, 0, 8}}], 
         Polygon[{{6, 3, 7}, {6, 4, 7}, {7, 4, 8}, {7, 3, 8}}]}, {
        ViewPoint -> $CellContext`v$$, Axes -> $CellContext`a$$, 
         Boxed -> $CellContext`b$$, ImageSize -> 300}], 
      "Specifications" :> {{{$CellContext`v$$, {20, -19.8, 20}, 
          "view"}, {{20, -19.8, 20} -> "mysterious", Above -> "above", Below -> 
          "below", Front -> "front", Back -> "back", Left -> "left", Right -> 
          "right", {Left, Top} -> "left, top", {Right, Top} -> "right top"}, 
         ControlPlacement -> 1}, {{$CellContext`a$$, None, "axes"}, {
         None, True}, ControlType -> Checkbox, ControlPlacement -> 
         2}, {{$CellContext`b$$, False, "box"}, {False, True}, ControlType -> 
        ...
        Row[{
          ...
          Manipulate`Place[2], 
          Spacer[20], 
          Manipulate`Place[3]}]}, "Options" :> {ControlPlacement -> Above}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{347., {225., 232.}},
 ...
 CellID->607182485,ExpressionUUID->"72f10c1e-d39d-49c2-926f-dce49f5ed27e"],

Cell[TextData[{
 StyleBox["Mathematica",
  FontSlant->"Italic"],
 " is a very nice tool for building three-dimensional objects and to observe \
them from different viewpoints. From certain viewpoints, some objects look \
impossible. This Demonstration shows such an object, which is made of square \
beams that are perpendicular to each another. Can you give the object's \
length, width, and height? Can you find other viewpoints from which this \
object seems to be impossible?"
}], "ManipulateCaption",
 CellID->66809520,ExpressionUUID->"c579b88c-1789-4131-97eb-96f3e656373a"],
...
Cell["THINGS TO TRY", "ManipulateCaption",
 ...
 CellTags->
  "ControlSuggestions",ExpressionUUID->"96a33298-c1cd-4cac-b505-fd0409d9cbb2"],

Cell[TextData[Cell[BoxData[
 TooltipBox[
  PaneSelectorBox[{False->Cell[TextData[StyleBox["Rotate and Zoom in 3D",
    FontFamily->"Verdana"]],ExpressionUUID->
    "b5b1206f-4325-4ec4-84ad-8feb24334354"], True->Cell[TextData[StyleBox[
   "Rotate and Zoom in 3D",
    FontFamily->"Verdana",
    FontColor->GrayLevel[0.5]]],ExpressionUUID->
    "f43f00eb-640d-4539-a72c-18a8239a1ca0"]}, Dynamic[
...
of the screen.\\nHold down \"", 
  ...
  TooltipStyle->{
   FontFamily -> "Verdana", FontSize -> 10, FontColor -> GrayLevel[0.35], 
    Background -> 
    GrayLevel[
     0.98]}]],ExpressionUUID->"5ccca058-a106-42a1-904f-fe8b1a6a5d04"]], \
"ManipulateCaption",
 CellMargins->{{Inherited, Inherited}, {0, 0}},
 Deployed->True,
 FontFamily->"Verdana",
 CellTags->
  "ControlSuggestions",ExpressionUUID->"208b60ed-3dce-494a-b583-48a19fd5b49e"],
...
/Y/Zs7Ozly9fFovFw8PDP+MAf3R0lLSb4x0EZsAw2AbzYKG/AGc0UCI=
    ...
    "655b0b8c-f5b4-44f6-878e-1444e62f1899"], True->Cell[BoxData[
    GraphicsBox[RasterBox[CompressedData["
...
zfE/BGJAMMgG8SChPwC1foQX
     ...
     ImageSize->{194, 22},
     PlotRange->{{0, 194}, {0, 22}}]],ExpressionUUID->
    "16ceddba-fb44-4820-ae43-be2669f4f413"]}, Dynamic[
    CurrentValue["MouseOver"]]],
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/versions/source.jsp?id=\
LengthWidthAndHeightOfAnImpossibleObject"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
LengthWidthAndHeightOfAnImpossibleObject/\
LengthWidthAndHeightOfAnImpossibleObject-source.nb"]], \
"DemoSourceNotebookSection",
 ...
 CellFrameColor->RGBColor[
  0.87, 0.87, 0.87],ExpressionUUID->"70618723-a84c-498a-8eed-246c861d7b5c"],

Cell["PERMANENT CITATION", "CitationSection",ExpressionUUID->"3641da1e-781e-4ed8-92be-639b5fbf5416"],

Cell[TextData[{
 "\[NonBreakingSpace]",
 ButtonBox["Bernard Vuilleumier",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["https://demonstrations.wolfram.com/author.html?author=Bernard+\
Vuilleumier"], None},
  ButtonNote->
   "https://demonstrations.wolfram.com/author.html?author=Bernard+Vuilleumier"]
}], "Author",
 FontColor->GrayLevel[
  0.6],ExpressionUUID->"33aecc39-10cc-45d4-a50d-37ae9e495297"],

Cell[TextData[{
 "\"",
 ButtonBox["Length, Width, and Height of an Impossible Object",
  BaseStyle->"SiteLink",
  ButtonData->{
...
LengthWidthAndHeightOfAnImpossibleObject/"],
 ...
 "Published: ",
 "November 7, 2008"
}], "Citations",ExpressionUUID->"4e798d10-6a3f-42cb-a45c-8f6fd635aa38"],
...
\[ThickSpace]",
 ...
 FontSize->9,
 FontColor->GrayLevel[0.6],
 CellTags->"Copyright",ExpressionUUID->"3d8583f5-e132-472a-a595-54f49d2e43ac"]
},
Editable->False,
Saveable->False,
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[41020, 706, 316, 8, 70, "ManipulateCaption",ExpressionUUID->"96a33298-c1cd-4cac-b505-fd0409d9cbb2",
   CellTags->"ControlSuggestions"],
  Cell[41339, 716, 1310, 30, 70, "ManipulateCaption",ExpressionUUID->"208b60ed-3dce-494a-b583-48a19fd5b49e",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[49432, 893, 873, 23, 70, "Text",ExpressionUUID->"3d8583f5-e132-472a-a595-54f49d2e43ac",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 76168, 1462},
 {"Copyright", 76473, 1467}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1551, 34, 34446, 569, 70, "DemonstrationHeader",ExpressionUUID->"3aa3486b-397f-48d9-b989-59b9d0e5141c"],
Cell[36000, 605, 125, 0, 70, "DemoTitle",ExpressionUUID->"ab772b7c-e4d5-4b64-abe5-31b1f92ac11b"],
Cell[36128, 607, 4307, 85, 70, "Output",ExpressionUUID->"72f10c1e-d39d-49c2-926f-dce49f5ed27e",
 CellID->607182485],
Cell[40438, 694, 579, 10, 70, "ManipulateCaption",ExpressionUUID->"c579b88c-1789-4131-97eb-96f3e656373a",
 CellID->66809520],
Cell[41020, 706, 316, 8, 70, "ManipulateCaption",ExpressionUUID->"96a33298-c1cd-4cac-b505-fd0409d9cbb2",
 CellTags->"ControlSuggestions"],
Cell[41339, 716, 1310, 30, 70, "ManipulateCaption",ExpressionUUID->"208b60ed-3dce-494a-b583-48a19fd5b49e",
 CellTags->"ControlSuggestions"],
Cell[42652, 748, 5166, 96, 70, "DemoSourceNotebookSection",ExpressionUUID->"70618723-a84c-498a-8eed-246c861d7b5c",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[47821, 846, 100, 0, 70, "CitationSection",ExpressionUUID->"3641da1e-781e-4ed8-92be-639b5fbf5416"],
Cell[47924, 848, 405, 11, 70, "Author",ExpressionUUID->"33aecc39-10cc-45d4-a50d-37ae9e495297"],
Cell[48332, 861, 1097, 30, 70, "Citations",ExpressionUUID->"4e798d10-6a3f-42cb-a45c-8f6fd635aa38"],
Cell[49432, 893, 873, 23, 70, "Text",ExpressionUUID->"3d8583f5-e132-472a-a595-54f49d2e43ac",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature bQqDDI#BgNKogvmUlf3n5wr9 *)
