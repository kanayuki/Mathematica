...
NotebookDataLength[     82052,       1615]
NotebookOptionsPosition[     55848,       1049]
NotebookOutlinePosition[     82115,       1610]
CellTagsIndexPosition[     82004,       1604]
WindowTitle->Line Halftones of Photographic Images
WindowFrame->Normal*)
...
Cell["Line Halftones of Photographic Images", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`edgeCol$$ = GrayLevel[
    0], $CellContext`et$$ = 2., $CellContext`faceCol$$ = GrayLevel[
    1], $CellContext`im$$ = 2, $CellContext`op$$ = 0.85, $CellContext`r$$ = 
    80, $CellContext`rev$$ = False, $CellContext`wt$$ = 
    0.65, $CellContext`\[Alpha]$$ = Rational[1, 4] Pi, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`im$$], 2, 
       Style["Image ", Bold]}, 
      Dynamic[
       Thread[Range[5] -> Map[ImageResize[
           ExampleData[{"TestImage", #}], 75]& , $CellContext`picNames]]]}, {{
       Hold[$CellContext`r$$], 80, "resolution"}, {60, 70, 80, 90, 100}}, {{
       Hold[$CellContext`rev$$], False, ""}, {True, False}}, {
      Hold[
       Row[{"reverse tones ", 
         Manipulate`Place[1]}]], Manipulate`Dump`ThisIsNotAControl}, {
      Hold[
       Style["Lines", Bold]], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`\[Alpha]$$], Rational[1, 4] Pi, "direction"}, {
      Rational[1, 2] Pi -> "\[LongDash]", 0 -> " \[VerticalSeparator] ", 
       Rational[-1, 4] Pi -> " \\ ", Rational[1, 4] Pi -> " / "}}, {{
       Hold[$CellContext`wt$$], 0.65, "width"}, 0.1, 0.9, 0.01}, {{
       Hold[$CellContext`faceCol$$], 
       GrayLevel[1], "color"}, 
      GrayLevel[0.5]}, {{
       Hold[$CellContext`op$$], 0.85, "opacity"}, 0, 1, 0.01}, {
      Hold[
       Style["Edges", Bold]], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`et$$], 2., "thickness"}, 0.1, 5, 0.01}, {{
       Hold[$CellContext`edgeCol$$], 
       GrayLevel[0], "color"}, 
      GrayLevel[0.5]}}, Typeset`size$$ = {300., {148., 152.}}, 
    Typeset`update$$ = 0, Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`r$175225$$ = 0, $CellContext`rev$175226$$ = 
    False, $CellContext`\[Alpha]$175227$$ = False, $CellContext`wt$175228$$ = 
    0, $CellContext`op$175229$$ = 0, $CellContext`et$175230$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     2, StandardForm, 
      "Variables" :> {$CellContext`edgeCol$$ = 
        GrayLevel[0], $CellContext`et$$ = 2., $CellContext`faceCol$$ = 
        GrayLevel[1], $CellContext`im$$ = 2, $CellContext`op$$ = 
        0.85, $CellContext`r$$ = 80, $CellContext`rev$$ = 
        False, $CellContext`wt$$ = 0.65, $CellContext`\[Alpha]$$ = 
        Rational[1, 4] Pi}, "ControllerVariables" :> {
        Hold[$CellContext`r$$, $CellContext`r$175225$$, 0], 
        Hold[$CellContext`rev$$, $CellContext`rev$175226$$, False], 
        Hold[$CellContext`\[Alpha]$$, $CellContext`\[Alpha]$175227$$, False], 
        Hold[$CellContext`wt$$, $CellContext`wt$175228$$, 0], 
        Hold[$CellContext`op$$, $CellContext`op$175229$$, 0], 
        Hold[$CellContext`et$$, $CellContext`et$175230$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`dat$, $CellContext`coords$}, $CellContext`dat$ = 
         ImageData[
           ImageRotate[
            If[$CellContext`rev$$, ColorNegate, Identity][
             ColorConvert[
              ImageAdjust[
               ImageResize[
                Switch[$CellContext`im$$, 
                 Evaluate[
                  Apply[Sequence, 
                   Flatten[
                    Transpose[{
                    ...
                    Map[
                    ExampleData[{
                    "TestImage", #}]& , $CellContext`picNames]}]]]]], \
$CellContext`r$$]], "Grayscale"]], $CellContext`\[Alpha]$$ - Pi/
            2]]; $CellContext`coords$ = Table[
           Map[# + {$CellContext`i, 0}& , 
            $CellContext`pixToCoord[
             Part[$CellContext`dat$, $CellContext`i], Length[
               Part[$CellContext`dat$, $CellContext`i]] + 
             0, $CellContext`wt$$]], {$CellContext`i, 1, 
            Length[$CellContext`dat$]}]; Graphics[
          Rotate[{
            FaceForm[{
              Opacity[$CellContext`op$$], $CellContext`faceCol$$}], 
            EdgeForm[{
              AbsoluteThickness[$CellContext`et$$], $CellContext`edgeCol$$}], 
            Polygon[$CellContext`coords$]}, -$CellContext`\[Alpha]$$], 
          PlotRange -> If[
            
            Or[$CellContext`\[Alpha]$$ == 0, $CellContext`\[Alpha]$$ == 
             Pi/2], {{1, $CellContext`r$$}, {
             1, $CellContext`r$$}}, (
              Sqrt[2. $CellContext`r$$^2] - $CellContext`r$$)/
             2 + {{1, $CellContext`r$$}, {1, $CellContext`r$$}}], ImageSize -> 
          300]], "Specifications" :> {{{$CellContext`im$$, 2, 
          Style["Image ", Bold]}, 
         Dynamic[
          Thread[Range[5] -> Map[ImageResize[
              ExampleData[{"TestImage", #}], 75]& , $CellContext`picNames]]], 
         ControlType -> PopupMenu}, {{$CellContext`r$$, 80, "resolution"}, {
         60, 70, 80, 90, 100}, ControlType -> 
         SetterBar}, {{$CellContext`rev$$, False, ""}, {True, False}, 
         ControlPlacement -> 1}, 
        Row[{"reverse tones ", 
          Manipulate`Place[1]}], Delimiter, 
        Style[
        "Lines", 
         Bold], {{$CellContext`\[Alpha]$$, Rational[1, 4] Pi, "direction"}, {
         Rational[1, 2] Pi -> "\[LongDash]", 0 -> " \[VerticalSeparator] ", 
          Rational[-1, 4] Pi -> " \\ ", Rational[1, 4] Pi -> 
          " / "}}, {{$CellContext`wt$$, 0.65, "width"}, 0.1, 0.9, 0.01, 
         ImageSize -> Tiny, Appearance -> 
         "Labeled"}, {{$CellContext`faceCol$$, 
          GrayLevel[1], "color"}, Gray, ControlType -> ColorSlider, 
         ImageSize -> {110, 35}}, {{$CellContext`op$$, 0.85, "opacity"}, 0, 1,
          0.01, ImageSize -> Tiny, Appearance -> "Labeled"}, Delimiter, 
        Style[
        "Edges", Bold], {{$CellContext`et$$, 2., "thickness"}, 0.1, 5, 0.01, 
         ImageSize -> Tiny, Appearance -> 
         "Labeled"}, {{$CellContext`edgeCol$$, 
          GrayLevel[0], "color"}, Gray, ControlType -> ColorSlider, 
         ImageSize -> {110, 35}}}, 
      "Options" :> {
       TrackedSymbols :> Manipulate, SynchronousUpdating -> False, 
        ControlPlacement -> Left, AutorunSequencing -> {3, 5, 6, 7, 8, 9}}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{518., {187., 192.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(($CellContext`picNames = {
        "Lena", "Mandrill", "Peppers", "Elaine", 
         "Tiffany"}; $CellContext`padLR[
         Pattern[$CellContext`lst, 
          Blank[]], 
         Pattern[$CellContext`len, 
          Blank[]]] := PadRight[
         PadLeft[$CellContext`lst, 
          
          Floor[($CellContext`len + Length[$CellContext`lst])/
           2]], $CellContext`len]; $CellContext`pixToCoord[
         Pattern[$CellContext`pixels, 
          Blank[List]], 
         Pattern[$CellContext`len, 
          Blank[]], 
         Optional[
          Pattern[$CellContext`f, 
           Blank[]], 1]] := 
       Module[{$CellContext`lst}, $CellContext`lst = \
$CellContext`padLR[$CellContext`pixels, $CellContext`len]; Partition[
           Flatten[{
             Riffle[$CellContext`f $CellContext`lst, 
              Range[1, $CellContext`len]], 
             Riffle[-Reverse[$CellContext`f $CellContext`lst], 
              Range[$CellContext`len, 1, -1]]}], 2]]); 
...
Cell["\<\
This Demonstration produces line halftones from a continuous-tone image, \
replacing rows of pixels by lines of varying width. \
\>", "ManipulateCaption"],

Cell["\<\
The lines are actually stretched polygons whose local cross section is \
proportional to the pixel value at that position. More variation can be \
obtained by changing the color, opacity, or width of the face or edges of the \
polygons.\
\>", "ManipulateCaption",
 CellID->100287444],
...
LineHalftonesOfPhotographicImages&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/LineHalftonesOfPhotographicImages/\
LineHalftonesOfPhotographicImages-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Line Halftones of Photographic Images",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/LineHalftonesOfPhotographicImages/\
"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/LineHalftonesOfPhotographicImages/"],
 "\"",
...
LineHalftonesOfPhotographicImages/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/LineHalftonesOfPhotographicImages/\
"], None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[44115, 782, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[44376, 791, 4440, 96, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[55026, 1024, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 81717, 1593},
 {"Copyright", 81912, 1598}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[35678, 602, 7971, 165, 70, "Output",
 CellID->110215427],
Cell[43652, 769, 164, 3, 70, "ManipulateCaption"],
Cell[43819, 774, 293, 6, 70, "ManipulateCaption",
 CellID->100287444],
Cell[44115, 782, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[44376, 791, 4440, 96, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48819, 889, 4838, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53660, 980, 45, 0, 70, "CitationSection"],
Cell[53708, 982, 324, 10, 70, "Author"],
Cell[54035, 994, 988, 28, 70, "Citations"],
Cell[55026, 1024, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature AQUIpTOuaSLjYuAfU4okna4v *)
