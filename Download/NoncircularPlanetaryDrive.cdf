...
NotebookDataLength[     86045,       1679]
NotebookOptionsPosition[     58659,       1103]
NotebookOutlinePosition[     84974,       1666]
CellTagsIndexPosition[     84863,       1660]
WindowTitle->Noncircular Planetary Drive
WindowFrame->Normal*)
...
ressionUUID->"3066505c-ed32-40da-9396-8b8f29774632"],

Cell["Noncircular Planetary Drive", "DemoTitle",ExpressionUUID->"fab74aa7-5917-4a1b-b42b-f71e472c6e3a"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`c$$ = 3, $CellContext`p1$$ = 
    0.035, $CellContext`p2$$ = 0.005, $CellContext`r$$ = 2, $CellContext`t$$ =
    ...
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
      ...
      Hold["speed ratio"], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`r$$], 2, ""}, 2, 5, 1}, {
      Hold["number of lobes"], Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`c$$], 3, ""}, {1, 2, 3, 4, 5}}, {
      Hold["displacement function parameters"], 
      Manipulate`Dump`ThisIsNotAControl}, {{
       Hold[$CellContext`p1$$], 0.035, 
       Subscript[$CellContext`p, 1]}, -0.035, 0.035, 0.001}, {{
       Hold[$CellContext`p2$$], 0.005, 
       Subscript[$CellContext`p, 2]}, -0.02, 0.02, 0.001}}, Typeset`size$$ = {
    350., {220.3544921875, 225.6455078125}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`t$153486$$ = 0, $CellContext`r$153487$$ = 
    0, $CellContext`c$153488$$ = 0, $CellContext`p1$153489$$ = 
    0, $CellContext`p2$153490$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`c$$ = 3, $CellContext`p1$$ = 
        0.035, $CellContext`p2$$ = 0.005, $CellContext`r$$ = 
        2, $CellContext`t$$ = 0.001}, "ControllerVariables" :> {
        Hold[$CellContext`t$$, $CellContext`t$153486$$, 0], 
        Hold[$CellContext`r$$, $CellContext`r$153487$$, 0], 
        Hold[$CellContext`c$$, $CellContext`c$153488$$, 0], 
        Hold[$CellContext`p1$$, $CellContext`p1$153489$$, 0], 
        Hold[$CellContext`p2$$, $CellContext`p2$153490$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`ring$, $CellContext`planet$, $CellContext`arm$, \
$CellContext`mx$}, $CellContext`\[Phi]$[
           Pattern[$CellContext`t$, 
            
            Blank[]]] := (-$CellContext`r$$) $CellContext`t$ - \
$CellContext`p1$$ 
          Sin[$CellContext`c$$ $CellContext`r$$ $CellContext`t$] - \
$CellContext`p2$$ 
          Sin[2 $CellContext`c$$ $CellContext`r$$ $CellContext`t$]; \
$CellContext`f$[
           Pattern[$CellContext`t$, 
            Blank[]]] := 
         Derivative[1][$CellContext`\[Phi]$][$CellContext`t$]/(1. + 
          Derivative[
           1][$CellContext`\[Phi]$][$CellContext`t$]); $CellContext`mx$ = 
         MaxValue[
           $CellContext`f$[$CellContext`x], $CellContext`x]; \
$CellContext`ring$ = Part[
           PolarPlot[
            $CellContext`f$[$CellContext`t$$], {$CellContext`t$$, 0, 2 Pi}, 
            PlotStyle -> {Thick, Blue}], 1]; $CellContext`planet$ = Part[
           ListLinePlot[
            ...
            Table[{1, 0} - ($CellContext`f$[$CellContext`t$$]/Derivative[
              ...
              0, 2 (Pi/$CellContext`r$$), Pi/75}], PlotStyle -> {Thick, Red}],
            1]; $CellContext`arm$ = {Thick, 
           Line[{{0.05, 0}, {0.95, 0}}]}; Column[{
           
           Plot[-Derivative[
             1][$CellContext`\[Phi]$][$CellContext`t$$], {$CellContext`t$$, 0,
              2 Pi}, PlotStyle -> Thick, 
            PlotRange -> {$CellContext`r$$ - 1, $CellContext`r$$ + 1}, 
            PlotLabel -> "angular speed ratio planet/arm", Frame -> True, 
            FrameLabel -> {
              Style["angular displacement of arm", 12], ""}, FrameTicks -> {
              Range[0, 2 Pi, Pi/2], Automatic, None, None}, GridLines -> 
            Automatic, GridLinesStyle -> Dashed, Epilog -> Dynamic[{
               PointSize[0.015], 
               
               Point[{$CellContext`t$$, -
                 Derivative[1][$CellContext`\[Phi]$][$CellContext`t$$]}]}], 
            AspectRatio -> 0.35, ImageSize -> 350], 
           Graphics[{$CellContext`ring$, {
              Rotate[{$CellContext`arm$, {
                 
                 Rotate[$CellContext`planet$, \
-$CellContext`\[Phi]$[$CellContext`t$$], {1, 0}]}, {Thick, Red, 
                 Circle[{1, 0}, 0.05]}}, -$CellContext`t$$, {0, 0}], {
              Blue, Thick, 
               Circle[{0, 0}, 0.05]}}}, Axes -> True, Ticks -> None, 
            AxesStyle -> DotDashed, PlotRange -> $CellContext`mx$, 
            ImageSize -> {350, 275}]}, Center, 1]], 
      "Specifications" :> {
       "animation", {{$CellContext`t$$, 0.001, ""}, 0.001, 2 Pi, ControlType -> 
         Trigger, AnimationRepetitions -> DirectedInfinity[1], AnimationRate -> 
         1}, Delimiter, 
        "speed ratio", {{$CellContext`r$$, 2, ""}, 2, 5, 1, ImageSize -> 
         Small, Appearance -> "Labeled"}, 
        "number of lobes", {{$CellContext`c$$, 3, ""}, {1, 2, 3, 4, 5}}, 
        Delimiter, 
        "displacement function parameters", {{$CellContext`p1$$, 0.035, 
          Subscript[$CellContext`p, 1]}, -0.035, 0.035, 0.001, ImageSize -> 
         Tiny, Appearance -> "Labeled"}, {{$CellContext`p2$$, 0.005, 
          Subscript[$CellContext`p, 2]}, -0.02, 0.02, 0.001, ImageSize -> 
         Tiny, Appearance -> "Labeled"}}, 
      "Options" :> {TrackedSymbols :> Manipulate, ControlPlacement -> Left}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{563., {251., 256.}},
 ...
 CellID->1875707820,ExpressionUUID->"69c294ee-6dcc-4990-b98a-b3a758a22ae1"],

Cell["\<\
This Demonstration simulates a noncircular planetary roller drive by two \
curves (ring and planet), with the inside planet rolling without slipping. \
\>", "ManipulateCaption",
 CellID->829216496,ExpressionUUID->"a7473115-1872-48b1-8508-45eb4650895d"],

Cell["\<\
The arm connecting the center of the two curves is driven at a constant \
speed; the outer ring curve is stationary. The planet curve turns at a \
variable angular speed proportional to the ratio between the radii of the two \
curves at their contact point.\
\>", "ManipulateCaption",
 CellID->1306434128,ExpressionUUID->"7aa61843-5f1b-4817-b71a-77ccfdfd059f"],

Cell[TextData[{
 "These curves can be interpreted as the pitch lines (or centrodes) of \
real-world gears. Not all combinations of ",
 Cell[BoxData[
  FormBox["c", TraditionalForm]], "InlineMath",ExpressionUUID->
  "9e7d393d-fd6a-4d52-81a1-9545a2a03cfe"],
 ", (the number of lobes, teeth, or leaves), ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["p", "1"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "01e3f34e-a8e4-4b6c-ba4e-29cd80b6f844"],
 ", and ",
 Cell[BoxData[
  FormBox[
   SubscriptBox["p", "2"], TraditionalForm]], "InlineMath",ExpressionUUID->
  "88a50b37-57ee-4916-acbf-5af94119a7d9"],
 " are practically feasible since some choices may cause the curves to \
overlap."
}], "ManipulateCaption",
 CellID->2080213055,ExpressionUUID->"55aa2508-d2a8-4062-90a6-fbeedaebcd64"],
...
Cell["THINGS TO TRY", "ManipulateCaption",
 ...
 CellTags->
  "ControlSuggestions",ExpressionUUID->"b4789bcd-66d3-487a-a1dd-f60d69ce76cb"],
 ...
 Cell[BoxData[
  TooltipBox[
   PaneSelectorBox[{False->Cell[TextData[StyleBox["Resize Images",
     ...
     "a0cae4cf-68d3-4c69-98ce-517515f9016f"], True->Cell[TextData[StyleBox[
    "Resize Images",
     FontFamily->"Verdana",
     FontColor->GrayLevel[0.5]]],ExpressionUUID->
     "52375dd2-32b6-46c7-a8de-6e2da42ed0f8"]}, Dynamic[
...
the orange resize handles to resize the image.\"",
  ...
  "47337108-e2b7-4fa6-9baa-5dbff1c41be3"],
 ...
 Cell[BoxData[
  TooltipBox[
   PaneSelectorBox[{False->Cell[TextData[StyleBox["Slider Zoom",
     FontFamily->"Verdana"]],ExpressionUUID->
     "c979549d-0a2b-45f7-818a-5dee76bca167"], True->Cell[TextData[StyleBox[
    "Slider Zoom",
     FontFamily->"Verdana",
     FontColor->GrayLevel[0.5]]],ExpressionUUID->
     "b21f155e-e428-46f4-8b8b-8db910cc267c"]}, Dynamic[
     CurrentValue["MouseOver"]]],
...
value.\\nHold \"", 
   ...
   TooltipStyle->{
    FontFamily -> "Verdana", FontSize -> 10, FontColor -> GrayLevel[0.35], 
     Background -> GrayLevel[0.98]}]],ExpressionUUID->
  "99e3db8d-e06b-4205-89c5-e5082dd224ab"],
 StyleBox["\[NonBreakingSpace]\[FilledVerySmallSquare]\[NonBreakingSpace]",
  FontColor->RGBColor[0.928786, 0.43122, 0.104662]],
 Cell[BoxData[
  TooltipBox[
   PaneSelectorBox[{False->Cell[TextData[StyleBox["Gamepad Controls",
     FontFamily->"Verdana"]],ExpressionUUID->
     "f9f86e8c-1e64-48b4-aefb-e69d850ed6b4"], True->Cell[TextData[StyleBox[
    "Gamepad Controls",
     FontFamily->"Verdana",
     FontColor->GrayLevel[0.5]]],ExpressionUUID->
     "f493d4de-c98f-4a3a-889c-45a54bbec6e2"]}, Dynamic[
     CurrentValue["MouseOver"]]],
...
device connected to your computer.\"",
   TooltipStyle->{
    FontFamily -> "Verdana", FontSize -> 10, FontColor -> GrayLevel[0.35], 
     Background -> GrayLevel[0.98]}]],ExpressionUUID->
  "031fc6d4-9aa9-42c4-9c3b-1f953f34f14c"],
 StyleBox["\[NonBreakingSpace]\[FilledVerySmallSquare]\[NonBreakingSpace]",
  FontColor->RGBColor[0.928786, 0.43122, 0.104662]],
 Cell[BoxData[
  TooltipBox[
   PaneSelectorBox[{False->Cell[TextData[StyleBox["Automatic Animation",
     FontFamily->"Verdana"]],ExpressionUUID->
     "e39a56af-f864-4af8-8470-8cda64fd6127"], True->Cell[TextData[StyleBox[
    "Automatic Animation",
     FontFamily->"Verdana",
     FontColor->GrayLevel[0.5]]],ExpressionUUID->
     "07c043a9-acda-4baf-a494-2824dce7f89b"]}, Dynamic[
     CurrentValue["MouseOver"]]],
...
UqiK6pPe4XdEdAz6563tx/gejuORGMxJaz8mdpJn7hc="], "Graphics", 
   ...
   TooltipStyle->{
    FontFamily -> "Verdana", FontSize -> 10, FontColor -> GrayLevel[0.35], 
     Background -> GrayLevel[0.98]}]],ExpressionUUID->
  "b61e2f15-155b-42f6-aa1a-6a7eaba8075b"]
}], "ManipulateCaption",
 CellMargins->{{Inherited, Inherited}, {0, 0}},
 Deployed->True,
 FontFamily->"Verdana",
 CellTags->
  "ControlSuggestions",ExpressionUUID->"09dbcb55-02ec-49d5-a89f-c9164e2186eb"],

Cell["DETAILS", "DetailsSection",ExpressionUUID->"ab46b0d8-8f76-4afe-8597-bd35550d6fcb"],

Cell["Reference", "DetailNotes",
 CellID->295120553,ExpressionUUID->"c2f84788-32da-44cd-a3a5-19f188c2afe9"],

Cell[TextData[{
 "[1] J. Doric, I. Klinar, and M. Dori, \"",
 ButtonBox["One Approach for Modelling Intermittent Motion Mechanism with \
Noncircular Gears,",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.mdesign.ftn.uns.ac.rs/pdf/2011/no2/121-126.pdf"], None},
  ButtonNote->"http://www.mdesign.ftn.uns.ac.rs/pdf/2011/no2/121-126.pdf"],
 "\" ",
 StyleBox["Machine Design",
  FontSlant->"Italic"],
 ", ",
 StyleBox["3",
  FontWeight->"Bold"],
 "(2), 2011 pp. 121\[Dash]126. ",
 ButtonBox["www.mdesign.ftn.uns.ac.rs/pdf/2011/no2/121-126.pdf",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.mdesign.ftn.uns.ac.rs/pdf/2011/no2/121-126.pdf"], None},
  ButtonNote->"http://www.mdesign.ftn.uns.ac.rs/pdf/2011/no2/121-126.pdf"],
 ...
 CellID->53495823,ExpressionUUID->"e516037a-505c-4a4d-a049-2c964c1d3aeb"],

Cell["RELATED LINKS", "RelatedLinksSection",ExpressionUUID->"1bcec6a2-5143-42e7-abe8-55e9d2c5964f"],
...
Cell[TextData[{
 ...
 CellID->98178071,ExpressionUUID->"d7e91edd-8a50-4cf1-b6c8-b195116438d1"],
...
/Y/Zs7Ozly9fFovFw8PDP+MAf3R0lLSb4x0EZsAw2AbzYKG/AGc0UCI=
    ...
    "cef4adbd-1c54-49f4-8a20-4e9a7bebb274"], True->Cell[BoxData[
    GraphicsBox[RasterBox[CompressedData["
...
zfE/BGJAMMgG8SChPwC1foQX
     ...
     ImageSize->{194, 22},
     PlotRange->{{0, 194}, {0, 22}}]],ExpressionUUID->
    "52f53bb8-7dbb-49f1-9724-e4c08563a4db"]}, Dynamic[
    CurrentValue["MouseOver"]]],
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/versions/source.jsp?id=\
NoncircularPlanetaryDrive"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/NoncircularPlanetaryDrive/\
NoncircularPlanetaryDrive-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
 ...
 CellFrameColor->RGBColor[
  0.87, 0.87, 0.87],ExpressionUUID->"55a9bf90-979e-4a38-b265-39fa3c599b8d"],

Cell["PERMANENT CITATION", "CitationSection",ExpressionUUID->"15e0e3c6-09e8-4c35-844a-185e29e5b2e6"],
...
Cell[TextData[{
 ...
 FontColor->GrayLevel[
  0.6],ExpressionUUID->"d4197c0e-986a-40c5-80cd-d09880ab1c59"],

Cell[TextData[{
 "\"",
 ButtonBox["Noncircular Planetary Drive",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/NoncircularPlanetaryDrive/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/NoncircularPlanetaryDrive/"],
 "\"",
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 ButtonBox["http://demonstrations.wolfram.com/NoncircularPlanetaryDrive/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/NoncircularPlanetaryDrive/"], None},
  ButtonNote->
 ...
 "\[ParagraphSeparator]\[NonBreakingSpace]",
 "Published: "
}], "Citations",ExpressionUUID->"4ed54b3e-18d9-48a7-b99d-d39d3f4b87a0"],
...
\[ThickSpace]",
 ...
 FontSize->9,
 FontColor->GrayLevel[0.6],
 CellTags->"Copyright",ExpressionUUID->"4f5392ce-217f-4d8f-a125-62d619a0eb99"]
},
Editable->False,
Saveable->False,
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[43946, 769, 316, 8, 70, "ManipulateCaption",ExpressionUUID->"b4789bcd-66d3-487a-a1dd-f60d69ce76cb",
   CellTags->"ControlSuggestions"],
  Cell[44265, 779, 5233, 112, 70, "ManipulateCaption",ExpressionUUID->"09dbcb55-02ec-49d5-a89f-c9164e2186eb",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[57782, 1078, 873, 23, 70, "Text",ExpressionUUID->"4f5392ce-217f-4d8f-a125-62d619a0eb99",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 84410, 1649},
 {"Copyright", 84716, 1654}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1529, 34, 34451, 570, 70, "DemonstrationHeader",ExpressionUUID->"3066505c-ed32-40da-9396-8b8f29774632"],
Cell[35983, 606, 103, 0, 52, "DemoTitle",ExpressionUUID->"fab74aa7-5917-4a1b-b42b-f71e472c6e3a"],
Cell[36089, 608, 6425, 124, 519, "Output",ExpressionUUID->"69c294ee-6dcc-4990-b98a-b3a758a22ae1",
 CellID->1875707820],
Cell[42517, 734, 262, 4, 59, "ManipulateCaption",ExpressionUUID->"a7473115-1872-48b1-8508-45eb4650895d",
 CellID->829216496],
Cell[42782, 740, 370, 6, 76, "ManipulateCaption",ExpressionUUID->"7aa61843-5f1b-4817-b71a-77ccfdfd059f",
 CellID->1306434128],
Cell[43155, 748, 788, 19, 70, "ManipulateCaption",ExpressionUUID->"55aa2508-d2a8-4062-90a6-fbeedaebcd64",
 CellID->2080213055],
Cell[43946, 769, 316, 8, 70, "ManipulateCaption",ExpressionUUID->"b4789bcd-66d3-487a-a1dd-f60d69ce76cb",
 CellTags->"ControlSuggestions"],
Cell[44265, 779, 5233, 112, 70, "ManipulateCaption",ExpressionUUID->"09dbcb55-02ec-49d5-a89f-c9164e2186eb",
 CellTags->"ControlSuggestions"],
Cell[49501, 893, 88, 0, 70, "DetailsSection",ExpressionUUID->"ab46b0d8-8f76-4afe-8597-bd35550d6fcb"],
Cell[49592, 895, 107, 1, 70, "DetailNotes",ExpressionUUID->"c2f84788-32da-44cd-a3a5-19f188c2afe9",
 CellID->295120553],
Cell[49702, 898, 849, 22, 70, "DetailNotes",ExpressionUUID->"e516037a-505c-4a4d-a049-2c964c1d3aeb",
 CellID->53495823],
Cell[50554, 922, 99, 0, 70, "RelatedLinksSection",ExpressionUUID->"1bcec6a2-5143-42e7-abe8-55e9d2c5964f"],
Cell[50656, 924, 536, 14, 70, "RelatedLinks",ExpressionUUID->"d7e91edd-8a50-4cf1-b6c8-b195116438d1",
 CellID->98178071],
Cell[51195, 940, 5124, 95, 70, "DemoSourceNotebookSection",ExpressionUUID->"55a9bf90-979e-4a38-b265-39fa3c599b8d",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[56322, 1037, 100, 0, 70, "CitationSection",ExpressionUUID->"15e0e3c6-09e8-4c35-844a-185e29e5b2e6"],
Cell[56425, 1039, 382, 11, 70, "Author",ExpressionUUID->"d4197c0e-986a-40c5-80cd-d09880ab1c59"],
Cell[56810, 1052, 969, 24, 70, "Citations",ExpressionUUID->"4ed54b3e-18d9-48a7-b99d-d39d3f4b87a0"],
Cell[57782, 1078, 873, 23, 70, "Text",ExpressionUUID->"4f5392ce-217f-4d8f-a125-62d619a0eb99",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature QvD7DvNHagRx3D1XKqZixd6a *)
