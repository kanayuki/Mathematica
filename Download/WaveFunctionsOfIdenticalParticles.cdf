...
NotebookDataLength[     78882,       1592]
NotebookOptionsPosition[     51578,       1003]
NotebookOutlinePosition[     77842,       1564]
CellTagsIndexPosition[     77731,       1558]
WindowTitle->Wave Functions of Identical Particles
WindowFrame->Normal*)
...
Cell["Wave Functions of Identical Particles", "DemoTitle",
 CellID->700863240],
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`k1$$ = 1, $CellContext`k2$$ = 2, 
    ...
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`k1$$], 1, "quantum number particle 1"}, 1, 10}, {{
       Hold[$CellContext`k2$$], 2, "quantum number particle 2"}, 1, 10}}, 
    Typeset`size$$ = {500., {97., 103.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`k1$193368$$ = 0, $CellContext`k2$193369$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`k1$$ = 1, $CellContext`k2$$ = 2}, 
      "ControllerVariables" :> {
        Hold[$CellContext`k1$$, $CellContext`k1$193368$$, 0], 
        Hold[$CellContext`k2$$, $CellContext`k2$193369$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Grid[{
          ...
          Map[$CellContext`\[CapitalPsi]Plot[#, {$CellContext`k1$$, \
$CellContext`k2$$}]& , {$CellContext`\[CapitalPsi]C, $CellContext`\
\[CapitalPsi]S, $CellContext`\[CapitalPsi]A}]}], {500, 200}, 
        Alignment -> {Center, Center}], 
      "Specifications" :> {{{$CellContext`k1$$, 1, 
          "quantum number particle 1"}, 1, 
         10}, {{$CellContext`k2$$, 2, "quantum number particle 2"}, 1, 10}}, 
      "Options" :> {}, "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {156., 161.}},
    ...
    Initialization:>(($CellContext`\[Psi][
         ...
         Pattern[$CellContext`x, 
          Blank[]]] := 
       Sqrt[2/Pi] 
        Sin[$CellContext`k $CellContext`x]; $CellContext`\[CapitalPsi]C[{
         ...
         Pattern[$CellContext`y, 
          ...
          Blank[]]] := $CellContext`\[Psi][$CellContext`k1][$CellContext`x] \
$CellContext`\[Psi][$CellContext`k2][$CellContext`y]; $CellContext`\
\[CapitalPsi]S[{
          Pattern[$CellContext`k1, 
           Blank[]], 
          Pattern[$CellContext`k2, 
         ...
         Pattern[$CellContext`y, 
          ...
          Blank[]]] := ($CellContext`\[Psi][$CellContext`k1][$CellContext`x] \
$CellContext`\[Psi][$CellContext`k2][$CellContext`y] + \
$CellContext`\[Psi][$CellContext`k1][$CellContext`y] \
$CellContext`\[Psi][$CellContext`k2][$CellContext`x])/Sqrt[
        2]; $CellContext`\[CapitalPsi]A[{
          Pattern[$CellContext`k1, 
           Blank[]], 
          Pattern[$CellContext`k2, 
           Blank[]]}][
        ...
        2]; $CellContext`\[CapitalPsi]Plot[
         Pattern[$CellContext`\[CapitalPsi], 
          ...
          Pattern[$CellContext`k2, 
           Blank[]]}] := Plot3D[
         Evaluate[Abs[
            $CellContext`\[CapitalPsi][{$CellContext`k1, \
$CellContext`k2}][$CellContext`x, $CellContext`y]]^2], {$CellContext`x, 0, 
          Pi}, {$CellContext`y, 0, Pi}, Mesh -> False, Axes -> False, 
         PlotRange -> All, PlotLabel -> 
         Which[$CellContext`\[CapitalPsi] === $CellContext`\[CapitalPsi]C, 
           Style[
           "Boltzmann", "Label", 
            14], $CellContext`\[CapitalPsi] === $CellContext`\[CapitalPsi]S, 
           Style[
           "Bosons", "Label", 
            14], $CellContext`\[CapitalPsi] === $CellContext`\[CapitalPsi]A, 
           Style["Fermions", "Label", 14]], ImageSize -> 140, Boxed -> False]; 
...
Cell["\<\
Quantum mechanical probability density for two particles in a 1D well with \
infinite walls.\
\>", "ManipulateCaption",
 CellID->1044312921],
...
Cell["\<\
In classical statistical mechanics, identical particles are considered \
indistinguishable from each other (the Boltzmann\[Hyphen]Gibbs case). Quantum \
mechanically, an elementary particle (meaning an irreducible \
finite-dimensional representation of the Poincar\[EAcute] group) is either a \
boson or a fermion, according to whether its spin (the Casimir operator of \
the Poincar\[EAcute] group) is an integer or a half-integer. Bosons and \
fermions cannot mix (superselection rule); wave functions representing \
identical bosons [fermions] must be fully symmetric [antisymmetric]. These \
symmetry requirements make an imprint on the probability distributions of \
particle groups. Statistically, bosons tend to be bunched together and \
fermions tend to keep away from each other, forming correlation holes. This \
Demonstration shows the two-particle probability distributions for the \
simplest possible case--particles in a square well. \
\>", "DetailNotes",
 CellID->356769978],
...
Cell[TextData[{
 ButtonBox["Particle",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Particle.html"], None}],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
  ButtonData->{
...
WaveFunctionsOfIdenticalParticles&version=0028"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/WaveFunctionsOfIdenticalParticles/\
WaveFunctionsOfIdenticalParticles-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Wave Functions of Identical Particles",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/WaveFunctionsOfIdenticalParticles/\
"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/WaveFunctionsOfIdenticalParticles/"],
 "\"",
...
WaveFunctionsOfIdenticalParticles/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/WaveFunctionsOfIdenticalParticles/\
"], None},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39862, 708, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40123, 717, 1761, 40, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[50756, 978, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 77445, 1547},
 {"Copyright", 77640, 1552}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[601, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34932, 590, 78, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[35013, 593, 4693, 107, 70, "Output",
 CellID->183493701],
Cell[39709, 702, 150, 4, 70, "ManipulateCaption",
 CellID->1044312921],
Cell[39862, 708, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40123, 717, 1761, 40, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41887, 759, 33, 0, 70, "DetailsSection"],
Cell[41923, 761, 999, 15, 70, "DetailNotes",
 CellID->356769978],
Cell[42925, 778, 44, 0, 70, "RelatedLinksSection"],
Cell[42972, 780, 430, 15, 70, "RelatedLinks",
 CellID->3420869],
Cell[43405, 797, 410, 14, 70, "RelatedLinks",
 CellID->409403157],
Cell[43818, 813, 403, 14, 70, "RelatedLinks",
 CellID->55336240],
Cell[44224, 829, 408, 14, 70, "RelatedLinks",
 CellID->286892825],
Cell[44635, 845, 4838, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[49476, 936, 45, 0, 70, "CitationSection"],
Cell[49524, 938, 879, 25, 70, "Citations"],
Cell[50406, 965, 347, 11, 70, "Author",
 CellID->305409422],
Cell[50756, 978, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature uRa#HLez0Fm9pxmqjBhLzFPx *)
