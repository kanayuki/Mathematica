...
NotebookDataLength[     83090,       1677]
NotebookOptionsPosition[     55664,       1086]
NotebookOutlinePosition[     81943,       1647]
CellTagsIndexPosition[     81832,       1641]
WindowTitle->Wave-Particle Duality in the Double-Slit Experiment
WindowFrame->Normal*)
...
Cell["Wave-Particle Duality in the Double-Slit Experiment", "DemoTitle"],
...
$CellContext`n$$}}, "DefaultOptions" :> {ControllerLinking -> True}],
    ...
    Initialization:>(({$CellContext`g1[
          ...
          Pattern[$CellContext`n, 
           ...
           Point[{10, (2 Re[#] - 2) 
              Boole[
               Sin[(2 Pi) Re[#]]^2 >= Im[#]], ((2 Im[#])/Sin[(2 Pi) Re[#]]^2 - 
               1) Boole[Sin[(2 Pi) Re[#]]^2 >= Im[#]]}]& , 
...
Cell["\<\
The \"central mystery\" of quantum mechanics is the wave-particle duality, as \
exemplified by the famous double-slit experiment. \
\>", "ManipulateCaption"],

Cell["\<\
In this idealized Demonstration, a special laser (not yet on the market!) can \
be tuned to any wavelength of visible light and triggered to emit pulses of \
up to 3500 photons. Small numbers of photons (or individual photons), after \
passing through the slits, produce scintillations at apparently random points \
on the screen. But as the number of photons per pulse is increased, a pattern \
of light and dark bands gradually emerges, with spacings determined by the \
wavelength and slit separation, which you can control with sliders. \
\>", "ManipulateCaption",
 CellID->65809534],

Cell["\<\
The intensities, in fact, trace out a classical diffraction pattern, first \
observed in Young's double-slit experiment. The trajectories of individual \
photons cannot be predicted. But each photon somehow \"knows\" about the \
entire diffraction pattern, which is exhibited only in the statistical \
behavior of a large number of photons. Remarkably, electrons and other \
particles behave analogously, in accord with their de Broglie wavelengths. \
This constitutes the fundamental basis for the quantum theory of matter.\
\>", "ManipulateCaption",
 CellID->315128047],
...
Cell["For more information:", "DetailNotes",
 CellID->1680988802],

Cell[TextData[{
 "S. M. Blinder, ",
 StyleBox[ButtonBox["Introduction to Quantum Mechanics in Chemistry, \
Materials Science, and Biology",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.amazon.com/Introduction-Quantum-Mechanics-Chemistry-\
Complementary/dp/0121060519/ref=pd_bbs_sr_1/002-4833970-9235227?ie=UTF8&s=\
books&qid=1193593772&sr=8-1"], None}],
  FontSlant->"Italic"],
 ", Burlington, MA: Elsevier Academic Press, 2004 pp. 17\[Dash]24."
}], "DetailNotes",
 CellID->327578823],
...
Cell[TextData[{
 ButtonBox["Double Slit Interference",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/DoubleSlitInterference.html"]\
, None}],
 " (",
...
Cell[TextData[{
 ButtonBox["Wave-Particle Duality",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://scienceworld.wolfram.com/physics/Wave-ParticleDuality.html"], 
    None}],
 " (",
 StyleBox[ButtonBox["ScienceWorld",
  BaseStyle->"SiteLink",
...
Cell[TextData[{
 ButtonBox["A Thousand Points of Light",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://blog.wolfram.com/2007/10/a_thousand_points_of_light.html#\
more"], None}],
 " (",
...
WaveParticleDualityInTheDoubleSlitExperiment&version=0011"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
WaveParticleDualityInTheDoubleSlitExperiment/\
WaveParticleDualityInTheDoubleSlitExperiment-source.nb"]], \
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[43423, 775, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[43684, 784, 2980, 67, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[54842, 1061, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 81545, 1630},
 {"Copyright", 81740, 1635}
 }
*)
(*NotebookFileOutline
Notebook[{
...
Cell[35021, 592, 7045, 154, 70, "Output",
 CellID->106689423],
Cell[42069, 748, 167, 3, 70, "ManipulateCaption"],
Cell[42239, 753, 597, 9, 70, "ManipulateCaption",
 CellID->65809534],
Cell[42839, 764, 581, 9, 70, "ManipulateCaption",
 CellID->315128047],
Cell[43423, 775, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43684, 784, 2980, 67, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46667, 853, 33, 0, 70, "DetailsSection"],
Cell[46703, 855, 65, 1, 70, "DetailNotes",
 CellID->1680988802],
Cell[46771, 858, 501, 12, 70, "DetailNotes",
 CellID->327578823],
Cell[47275, 872, 44, 0, 70, "RelatedLinksSection"],
Cell[47322, 874, 443, 15, 70, "RelatedLinks",
 CellID->1385177251],
Cell[47768, 891, 441, 15, 70, "RelatedLinks",
 CellID->1951324077],
Cell[48212, 908, 396, 14, 70, "RelatedLinks",
 CellID->376953969],
Cell[48611, 924, 4875, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[53489, 1017, 45, 0, 70, "CitationSection"],
Cell[53537, 1019, 952, 27, 70, "Citations"],
Cell[54492, 1048, 347, 11, 70, "Author",
 CellID->713761910],
Cell[54842, 1061, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature ITaIsHNiB6#sSvABRPHBIzaG *)
